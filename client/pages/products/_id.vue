...
<!-- ****** COMPONENT EXPLANATION ******-->
  <!-- _id.vue file inside products its a dyncamic path with _ (the name of the file is the route) -->
  <!-- so a file inside pages folder will react as a route - here is: localhost:3000/products/:id  -->
...
export default {
  computed: {
    // product will be called above as a props (by vuex)
    product() {
                                                //this.$route.params.id is equal to the file _id.vue from pages/products.
                                                // if we called it _id.vue js so the param will be without _ so only id
